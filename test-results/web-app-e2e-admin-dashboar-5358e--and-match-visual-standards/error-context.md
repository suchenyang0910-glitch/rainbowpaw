...
- Name: web-app\e2e\admin\dashboard.spec.ts >> Admin Dashboard >> should display dashboard correctly and match visual standards
- Location: web-app\e2e\admin\dashboard.spec.ts:21:3
